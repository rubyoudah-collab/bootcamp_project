...
echo  $d': Altering students table...' | tee -a logs/v2_alter_students_table.log
mysql -u root -proot < db_version_2/alter_students_table.sql 2>&1 | tee -a logs/v2_alter_students_table.log
